...
if(user.lang == 'en'){
    ...
    let days = document.querySelector('.days').innerHTML = ms.length+1 + ' днів'
    let repeats = document.querySelector('.times').innerHTML = times + ' повторів за ' + Number(ms.length+1) + ' днів' 
